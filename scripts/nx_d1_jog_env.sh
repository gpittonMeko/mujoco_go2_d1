...
export D1_GRASP6D_AUTO_REST_S="${D1_GRASP6D_AUTO_REST_S:-0.6}"
...
export D1_GRASP6D_AUTO_STUCK_OFFSET_SCALE="${D1_GRASP6D_AUTO_STUCK_OFFSET_SCALE:-1.35}"
export D1_GRASP6D_AUTO_MIN_VISIBLE_TAGS="${D1_GRASP6D_AUTO_MIN_VISIBLE_TAGS:-10}"
# Hand-eye lab: soglie raggiungibili con orbit D1 (non 1cm/3° irrealistici).
...
export D1_GRASP6D_CALIB_TARGET_ROTATION_SPAN_DEG="${D1_GRASP6D_CALIB_TARGET_ROTATION_SPAN_DEG:-25}"
export D1_GRASP6D_CALIB_SOFT_NEW_TRANSLATION_M="${D1_GRASP6D_CALIB_SOFT_NEW_TRANSLATION_M:-0.012}"
export D1_GRASP6D_CALIB_SOFT_NEW_ROTATION_DEG="${D1_GRASP6D_CALIB_SOFT_NEW_ROTATION_DEG:-4.0}"
