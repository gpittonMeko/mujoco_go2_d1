...
class D1RgbAndMotorUiTests(unittest.TestCase):
    ...
    def test_arm_runtime_and_daemon_regressions_are_guarded(self) -> None:
        ...
        self.assertIn("max_samples_still_residual_high", app)
        self.assertIn("AUTO_STUCK_OFFSET_SCALE", env)
        self.assertIn("max_samples: 16", (ROOT / "templates" / "d1_jog_dashboard.html").read_text(encoding="utf-8", errors="replace"))
