...
class D1RgbAndMotorUiTests(unittest.TestCase):
    ...
    def test_arm_runtime_and_daemon_regressions_are_guarded(self) -> None:
        ...
        self.assertIn('D1_GRASP6D_AUTO_MOVE_MODE="${D1_GRASP6D_AUTO_MOVE_MODE:-0}"', env)
        self.assertIn('D1_GRASP6D_AUTO_WAYPOINT_DELAY_MS="${D1_GRASP6D_AUTO_WAYPOINT_DELAY_MS:-120}"', env)
        self.assertIn('D1_GRASP6D_AUTO_REST_S="${D1_GRASP6D_AUTO_REST_S:-0.8}"', env)
