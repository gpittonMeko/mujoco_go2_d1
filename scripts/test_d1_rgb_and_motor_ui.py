...
class D1RgbAndMotorUiTests(unittest.TestCase):
    ...
    def test_arm_runtime_and_daemon_regressions_are_guarded(self) -> None:
        ...
        self.assertIn('D1_GRASP6D_AUTO_REST_S="${D1_GRASP6D_AUTO_REST_S:-0.5}"', env)
        self.assertIn('D1_GRASP6D_AUTO_SETTLE_S="${D1_GRASP6D_AUTO_SETTLE_S:-1.2}"', env)
        self.assertIn('D1_GRASP6D_AUTO_SEARCH_ENABLE="${D1_GRASP6D_AUTO_SEARCH_ENABLE:-1}"', env)
