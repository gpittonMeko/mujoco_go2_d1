...
curl -sS -m 3 "http://127.0.0.1:${GO2_DASHBOARD_PORT:-5052}/api/health" 2>/dev/null || echo "curl health failed"
echo ""
echo "=== serve_dashboard / diagnostics PIDs ==="
pgrep -af 'serve_dashboard_lite|serve_dashboard_modular|diagnostics_dashboard' 2>/dev/null || echo "(none)"
