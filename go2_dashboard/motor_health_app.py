...
<head>
  ...
  <style>
    ...
    .meta { color: #8b9aab; font-size: 0.9rem; margin-bottom: 1rem; }
    .badge { display: inline-block; padding: 0.15rem 0.5rem; border-radius: 4px; font-size: 0.8rem; }
    .ok { background: #1a3d2e; color: #6ee7a0; }
    .warn { background: #4a3a12; color: #fbbf24; }
    .critical { background: #4a1515; color: #f87171; }
    .off { background: #2a2f36; color: #9ca3af; }
    table { width: 100%; border-collapse: collapse; font-size: 0.85rem; }
    th, td { text-align: left; padding: 0.35rem 0.5rem; border-bottom: 1px solid #243040; }
    th { color: #8b9aab; font-weight: 500; }
    .grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 0.75rem; margin: 1rem 0; }
    .card { background: #1a222c; border-radius: 8px; padding: 0.75rem 1rem; }
    .card h2 { margin: 0 0 0.4rem; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.04em; color: #8b9aab; }
    .card .val { font-size: 1.25rem; font-weight: 600; }
    .card.critical { border: 1px solid #7f1d1d; background: #2a1515; }
    .card.critical .val { color: #f87171; }
    .card.warn { border: 1px solid #854d0e; background: #2a2210; }
    ...
    .sport-btn {
      ...
      color: #e7ecf1; background: #2563eb;
    }
    .sport-btn.secondary { background: #334155; }
    .sport-btn:disabled { opacity: 0.55; cursor: wait; }
    #sportMsg { color: #94a3b8; font-size: 0.85rem; min-height: 1.2em; }
    .settings-panel {
      background: #1a222c; border-radius: 8px; padding: 0.85rem 1rem; margin: 0.75rem 0 1rem;
      border: 1px solid #243040;
    }
    .settings-panel h2 { margin: 0 0 0.6rem; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; color: #8b9aab; }
    .settings-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 0.65rem 1rem; }
    .settings-grid label { display: flex; flex-direction: column; gap: 0.25rem; font-size: 0.82rem; color: #94a3b8; }
    .settings-grid input[type="number"] {
      font: inherit; padding: 0.35rem 0.5rem; border-radius: 6px; border: 1px solid #334155;
      background: #0f1419; color: #e7ecf1; max-width: 8rem;
    }
    .settings-grid input[type="checkbox"] { width: 1rem; height: 1rem; accent-color: #2563eb; }
    .check-row { flex-direction: row !important; align-items: center; gap: 0.5rem !important; color: #e7ecf1 !important; }
    ...
    .settings-actions button {
      ...
      border-radius: 6px; border: none; cursor: pointer; color: #e7ecf1; background: #334155;
    }
    .settings-actions button.primary { background: #2563eb; }
    #settingsMsg { font-size: 0.82rem; color: #94a3b8; }
    #weightPlan { font-size: 0.82rem; color: #94a3b8; margin-top: 0.35rem; }
    .event-log-panel {
